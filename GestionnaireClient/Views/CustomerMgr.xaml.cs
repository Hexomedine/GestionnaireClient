...
{
    /// <summary>
    /// Logique d'interaction pour CustomerMgr.xaml
    /// </summary>
    public partial class CustomerMgr : UserControl
    {
        ...
        public static readonly DependencyProperty DbCtxtMgrProperty =
            DependencyProperty.Register("DbCtxtMgr", typeof(DBContextMgr), typeof(CustomerMgr)); 
        #endregion
